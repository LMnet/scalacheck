...
/**
  ...
  */
class SimpleRngSeed(a: Long, b: Long, c: Long, d: Long) extends Seed {
  ...
  /**
    ...
    */
  def toBase64: String = {
    def enc(x: Long): Char = SimpleRngSeed.Alphabet((x & 0x3f).toInt)
  ...
  def next: Seed = {
    ...
    val c1 = d + e
    val d1 = e + a
    SimpleRngSeed.fromLongs(a1, b1, c1, d1)
  }
  ...
  def reseed(n: Long): Seed = {
    ...
    val n1 = (n & 0xffffffff)
    var i = 0
    var seed: Seed = SimpleRngSeed.fromLongs(a ^ n0, b ^ n1, c, d)
  ...
  override def toString: String = s"""SimpleRngSeed.fromBase64("$toBase64")"""
}

object SimpleRngSeed {

  /** Generate a deterministic seed. */
  def apply(s: Long): Seed = {
    var i = 0
    var seed: Seed = SimpleRngSeed.fromLongs(0xf1ea5eed, s, s, s)
  ...
  /**
    ...
    * `SimpleRngSeed(Long)` if you aren't sure whether these will be good seed
    * values.
    */
